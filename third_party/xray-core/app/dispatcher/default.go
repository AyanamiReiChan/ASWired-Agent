...
func (d *DefaultDispatcher) getLink(ctx context.Context) (*transport.Link, *transport.Link) {
	...
	inboundLink.Writer = limitWriter(ctx, inboundLink.Writer, "upload")
	outboundLink.Writer = limitWriter(ctx, outboundLink.Writer, "download")
...
func (d *DefaultDispatcher) Dispatch(ctx context.Context, destination net.Destination) (*transport.Link, error) {
	...
	ctx, admissionErr = aswired.Admit(ctx)
	if admissionErr != nil {
...
func (d *DefaultDispatcher) DispatchLink(ctx context.Context, destination net.Destination, outbound *transport.Link) error {
	...
	outbound.Writer = limitWriter(ctx, outbound.Writer, "download")
	if aswired.Managed(ctx) {
		outbound.Reader = &aswiredReader{ctx, outbound.Reader.(buf.TimeoutReader)}
	}
	sniffingRequest := content.SniffingRequest
	if !sniffingRequest.Enabled {
		d.routedDispatch(ctx, outbound, destination)
